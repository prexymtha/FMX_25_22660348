...
```{r}
############################################################
# Q1: ABC Fund vs Benchmark and Peers – full code
############################################################
...
############################################################
# 1. Common sample and analysis_data ----
############################################################
...
### 3. Boxplot of 3-year rolling betas (Bonus Practical 2 style)

This is the bit we are changing. It uses the raw data, but it is filtered to the same date range so it is consistent with the rest of Q1.

```{r}
############################################################
# 3. Boxplot of 3-year rolling betas (Active vs ABC) ----
#    Nico / Bonus Practical 2 structure, adapted to our names
############################################################
