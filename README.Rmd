...
To see how much the fund differs from the rest of the industry in terms of what drives the return .We can perform a factor analysis or compare the R-squared from a market model to see how much of the returns are explained by the market ( we use R-squared).
...
We will be using analysis data to continue with our questions .We will do other interesting things (the above tables answer how much we differe from the rest of the industry)
...
chart.RiskReturnScatter(R=xts.data.dailyreturns['2003-01-01/'][,c("AGL", "AMS", "ANG", "AOD.Statistics Table (I want to do a replicate from bonus practical 2 Financial Statistics I am having issues)
